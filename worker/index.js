...
export class PairDirectory {
  ...
  cleanContext(value) { const context = value && typeof value === 'object' ? value : {}, type = context.type === 'server' ? 'server' : context.type === 'dm-persistent' ? 'dm-persistent' : 'dm'; return { type, serverId: normalizeId(context.serverId), channelId: normalizeId(context.channelId) }; }
