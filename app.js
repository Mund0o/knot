...
function wire(){
  if(chat){
    chat.onopen=()=>{setStatus(relayVoiceMode?'Voice relay active · files and screen share stay P2P':(pc?._lan?'Connected on this Wi-Fi':'Connected directly'),true);announceProfile();publishCallState(callActive);requestWatchState()};
