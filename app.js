...
function activateDmView(friend){if(!friend)return;activePeerId=friend.id;showFriends();applyFriendProfile(friend);openConversation('dm:'+friend.id);renderFriends();syncActiveDmTransport()}
