...
async function main() {
  ...
  if(cadenceReceiver.backend==='mse'&&cadenceReceiver.steadyStateP95Ms)assert(cadenceReceiver.steadyStateP95Ms<=150.000001,`MediaSource live latency exceeded the 150ms ceiling: ${cadenceReceiver.steadyStateP95Ms.toFixed(0)}ms`);
