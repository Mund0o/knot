...
app.whenReady().then(async () => {
  ...
  try {
    ...
    const result = await window.webContents.executeJavaScript(`(async()=>{
      ...
      return {dialog:true,collapse:true,resize:[before,after],friendSearch:true,serverRail:true,channelCreate:true,channelDelete:true,channelReorder:true,historySync:true,ownerControls:true,memberCollapse:true,displayConstraints:true,motionSender:true,audioWorklet:true,encoderRecovery:true,doubleClickVoice:true,voiceDock:true,voicePersists:true,serverMultiShare:true,dmCallDock:true,stickyCall:true,speakingRing:true,backgroundDmCall:true,persistentDm:true,dmMultiShare:true,stopWatching:true,fullscreenCleanup:true,remoteLeaveCleanup:true,themes:true};
    })()`, true);
