...
if (!rendererSource.includes('targetNativeAv1BitrateKbps(width,height,fps)') || !rendererSource.includes("createDataChannel('knot-screen-native',{ordered:true,maxPacketLifeTime:250,priority:'low'})") || !rendererSource.includes('NATIVE_SCREEN_BUFFER_HIGH=256*1024')) {
