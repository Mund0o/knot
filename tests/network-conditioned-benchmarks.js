...
assert(mesh.maxQueueMs<=180,'real-time stale-frame bound exceeded the 180 ms ceiling');
...
console.log('PASS deterministic network-conditioned latency benchmark preserves 110/180 ms targets without forcing them');
