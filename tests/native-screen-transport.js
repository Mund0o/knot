...
async function main() {
  ...
  if(result.backend==='mse'&&result.steadyStateP95Ms)assert(result.steadyStateP95Ms<=150.000001,`MediaSource live latency exceeded the 150ms ceiling: ${result.steadyStateP95Ms.toFixed(0)}ms`);
